...
<body class="dashboard-page">
   <header class="topbar">
       <div>
           <span class="brand-badge">Admin Ótica</span>
           <h1 class="dashboard-title">Painel Administrativo</h1>
       </div>

       <div class="topbar-actions">
           <a href="{{ route('admin.dashboard') }}" class="btn-outline">Dashboard</a>
           <a href="{{ route('admin.products.index') }}" class="btn-outline">Produtos</a>
           <a href="{{ route('admin.promotions.index') }}" class="btn-outline">Promoções</a>
